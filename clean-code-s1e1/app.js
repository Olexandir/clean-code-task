...
var incompleteTaskHolder=document.querySelector(".list.list-incompleted");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".list.list-completed");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='list__item'; // ! Добавлено
